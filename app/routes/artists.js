...
},
{
  ...
  about: 'Rachel Wolf specializes in camera-less photography, alternative/ antique processes, and immersive environments through light-based installations. Rachel exhibits her work nationally, and is an educator and speaker in the field. Originally from Anchorage, Alaska, Rachel earned her BA from Hampshire College and her MFA from Pacific Northwest College of Art. Rachel currently resides in Portland, OR.'
},
{
  id: 3,
  image: 'assets/images/thumbs/moran220sq.jpg',
  title: 'M. V. Moran',
  page: 'artist.moran',
  link: 'hhttp://www.mvmoran.com/',
  about: 'Moran earned her MFA in Visual Studies from Pacific Northwest College of Art, Portland, Oregon in 2016 and a BFA in Painting from the University of Oregon, Eugene, Oregon in 1999. Moran works in Eugene, Oregon.'
},
{
  id: 4,
  image: 'assets/images/thumbs/abbott220sq.jpg',
  title: 'Sarah Abbott',
  page: 'artist.abbott',
  link: 'http://www.sarahabbott-art.com/',
  about: 'Abbott is co-founder of FO(u)RT, an interdisciplinary art collective dedicated to collaboration and critical discourse. Her art practice is propelled by exploring the complexities and idiosyncrasies of her home—her corner of the world. Abbott currently exhibits locally and nationally.'
},
{
  id: 5,
  image: 'assets/images/thumbs/janchar220sq.jpg',
  title: 'Tim Janchar',
  page: 'artist.janchar',
  link: 'http://alotoflittlethings.com/home.html',
  about: 'Janchar is a member of the artist collective Danger Punch in Portland, Oregon.'
},
{
  id: 6,
...
},
{
  ...
  link: 'http://www.millaoliveira.com',

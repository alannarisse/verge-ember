...
define('verge-ember/adapters/application', ['exports', 'emberfire/adapters/firebase'], function (exports, _emberfireAdaptersFirebase) {
...
define('verge-ember/components/artist-gallery', ['exports', 'ember'], function (exports, _ember) {
...
define('verge-ember/components/berlin-gallery', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({});
});
...
define('verge-ember/components/justified-gallery', ['exports', 'ember-justified-gallery/components/justified-gallery'], function (exports, _emberJustifiedGalleryComponentsJustifiedGallery) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('verge-ember/components/light-box', ['exports', 'ember-cli-lightbox/components/light-box'], function (exports, _emberCliLightboxComponentsLightBox) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
...
define('verge-ember/initializers/ember-cli-lightbox', ['exports', 'verge-ember/config/environment', 'ember-cli-lightbox/initializers/ember-cli-lightbox'], function (exports, _vergeEmberConfigEnvironment, _emberCliLightboxInitializersEmberCliLightbox) {
  ...
  function initialize() {
    ...
    return _emberCliLightboxInitializersEmberCliLightbox['default'].initialize.apply(null, [_vergeEmberConfigEnvironment['default']['ember-cli-lightbox']].concat(args));
  }
...
define('verge-ember/initializers/emberfire', ['exports', 'emberfire/initializers/emberfire'], function (exports, _emberfireInitializersEmberfire) {
...
define('verge-ember/models/person', ['exports', 'ember-data'], function (exports, _emberData) {
...
define('verge-ember/models/post', ['exports', 'ember-data'], function (exports, _emberData) {
  exports['default'] = _emberData['default'].Model.extend({
...
define('verge-ember/routes/artist/quiroz', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
...
define('verge-ember/routes/news', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
...
define('verge-ember/routes/posts', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
...
define('verge-ember/services/firebase-app', ['exports', 'emberfire/services/firebase-app'], function (exports, _emberfireServicesFirebaseApp) {
  exports['default'] = _emberfireServicesFirebaseApp['default'];
});
define('verge-ember/services/firebase', ['exports', 'emberfire/services/firebase'], function (exports, _emberfireServicesFirebase) {
  exports['default'] = _emberfireServicesFirebase['default'];
});
define("verge-ember/templates/about", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "GnYWAeJJ", "block": "{\"statements\":[[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"about\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-sm-6 col-md-6\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"About Verge\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Verge is a Portland-based art curation and collaboration service. We believe that art should be lived with. We love bringing great emerging artists into non-traditional spaces, especially tech offices.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"We are always on the lookout for more spaces and artists. Let us curate your professional space with monthly or quarterly rotations of professional works from Oregon-based emerging artists. Contact \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=Verge art in my space\"],[\"flush-element\"],[\"text\",\"Alanna\"],[\"close-element\"],[\"text\",\" if you are a Portland area business looking for rotating art exhibits or if you are an artist interested in participating.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Verge was founded in May 2016. We currently curate the walls of \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://flickerbox.com\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Flickerbox Inc.\"],[\"close-element\"],[\"text\",\", a digital marketing agency in downtown Portland, Oregon, and \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.redfoxpdx.com/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"The Red Fox\"],[\"close-element\"],[\"text\",\", a great neighborhood bar in North Portland, Oregon. Help us expand our reach by providing us more walls. Spread the art love!\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Contact Us\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Interested a viewing appointment? \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=Viewing Appointment\"],[\"flush-element\"],[\"text\",\"Contact me\"],[\"close-element\"],[\"text\",\" via email.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Would you like Portland to rotate art shows in your Portland business? \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=Interested in Verge Curatorial Services\"],[\"flush-element\"],[\"text\",\"Contact me\"],[\"close-element\"],[\"text\",\".\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Artists: If you are interested in showing with Verge, please send me a link to your portfolio and a \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=artist interested in Verge\"],[\"flush-element\"],[\"text\",\"brief email\"],[\"close-element\"],[\"text\",\" describing how you see your work fitting into the Verge catalog.\"],[\"close-element\"],[\"text\",\"\\n\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-sm-6 col-md-6\"],[\"flush-element\"],[\"text\",\"\\n    \\t\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"About the Curator\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Hi, I'm \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://alannarisse.com\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Alanna Risse\"],[\"close-element\"],[\"text\",\". I live in two worlds. I have been both and artist and a web developer for most of my adult life. I've always been curious at the interesection between these two worlds. I've worked at a few tech companies with fantastic contemporary art collections and I love watching self proclaimed non-artists develop relationships with art in their workplace.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"I think office spaces can offer a really rich opportunity to develop a love of art, more so than a gallery or museum. When you can see the same works of art day after day, you get a much richer experience than if you spend 5 minutes (or less) looking at something in a gallery or museum. For me, this is where artworks can be transformed into something meaningful and powerful. I want to bring great art into spaces where people can experience it.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"open-element\",\"em\",[]],[\"flush-element\"],[\"text\",\"Education and Experience:\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n        MFA Visual Studies, \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://pnca.edu\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"PNCA\"],[\"close-element\"],[\"text\",\", 2015\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n        BFA Painting/Drawing, \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.cca.edu/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"CCA\"],[\"close-element\"],[\"text\",\" 2008\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://alannarisse.com/webdev\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Web Developer\"],[\"close-element\"],[\"text\",\" since 1998\"],[\"close-element\"],[\"text\",\"\\n\\t\\t  \"],[\"close-element\"],[\"text\",\"\\n\\t \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"about-social\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-sm-4 col-md-4\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://instagram.com/vergepdx\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-instagram\"],[\"static-attr\",\"style\",\"font-size:48px\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"instagram.com/vergepdx.com\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Instagram: @vergepdx\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-sm-4 col-md-4\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://facebook.com/vergepdx\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-facebook\"],[\"static-attr\",\"style\",\"font-size:48px\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://facebook.com/vergepdx\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Facebook: VergePDX\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-sm-4 col-md-4\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://twitter.com/vergepdx\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-twitter\"],[\"static-attr\",\"style\",\"font-size:48px\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://twitter.com/vergepdx\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Twitter: @vergepdx\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/about.hbs" } });
});
define("verge-ember/templates/application", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "WAT6PA6c", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"navigation-list\"]],false],[\"text\",\"\\n\"],[\"open-element\",\"header\",[]],[\"static-attr\",\"style\",\"background-image:url('/assets/images/verge_circles.png');background-repeat: no-repeat;\"],[\"flush-element\"],[\"open-element\",\"h1\",[]],[\"static-attr\",\"class\",\"logo\"],[\"flush-element\"],[\"block\",[\"link-to\"],[\"index\"],null,0],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"comment\",\" <header><h1>{{#link-to 'index'}}<img src=\\\"/assets/images/verge_logo_lg02.png\\\" alt=\\\"verge\\\">{{/link-to}}</h1></header> \"],[\"text\",\"\\n\"],[\"open-element\",\"p\",[]],[\"static-attr\",\"class\",\"tagline\"],[\"flush-element\"],[\"text\",\"Art Curation in Portland, Oregon\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"container\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"append\",[\"unknown\",[\"footer-nav\"]],false],[\"text\",\"\\n\"],[\"comment\",\"  style=\\\"background-image:url('/assets/images/verge_circles.png');background-repeat: no-repeat;\\\" \"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\" Verge\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/application.hbs" } });
});
define("verge-ember/templates/artist/berlin", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "/9NfOV/0", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Jason Berlin\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,1],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tMarch 2017\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,0],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tAugust, 2016\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"],[\"comment\",\" {{#justified-gallery  captions=true}}\\n\\n    \\t{{#each model as |berlinGallery|}}\\n \\t\\t\\t{{berlin-gallery berlinGallery=berlinGallery}}\\n \\t\\t{{/each}}\\n\\n{{/justified-gallery}} \"],[\"text\",\"\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/berlin/zags1024.jpg\",\"berlin-group\",\"Zags\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/berlin/lno03.jpg\",\"berlin-group\",\"Last Night Out\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/berlin/lno08.jpg\",\"berlin-group\",\"Last Night Out\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/berlin/lno09.jpg\",\"berlin-group\",\"Last Night Out\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/berlin/lno10.jpg\",\"berlin-group\",\"Last Night Out\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\n\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Biograhy\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Jason Berlin received his BFA from Oregon Collage of Art and Craft and his MFA in Visual Studies at Hallie Ford School of Graduate Studies at Pacific Northwest College of Art. (Portland OR ) Berlin works  in the medium of oil painting, sculpture, installation, college, and curation. In 2016 Berlin started Stall Gallery as a curatorial project and in 2016 was awarded six month artist in residency at Rainmaker artist residency in Portland, Oregon. Berlin’s work has been exhibited in numerous art shows in the Pacific Northwest, and in group exhibitions in New York, France, and Vancouver BC. Berlin splits his time between the rural country side of Longview Washington ( his home town ) and urban life where he lives in Portland Oregon.\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://jasonberlinthomas.com\"],[\"flush-element\"],[\"text\",\"Jason Berlin\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Flickerbox, Inc., PDX\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Red Fox\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/berlin.hbs" } });
});
define("verge-ember/templates/artist/kruse", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "ENOQT5Mt", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Brandi Kruse\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,0],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tNovember 2016\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"comment\",\" <p><img src=\\\"/assets/images/kruse/bikes1024.jpg\\\"></p> \"],[\"text\",\"\\n\\n\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n\\t    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/bottle.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/cake.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/clouds.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/inside-out.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/lamplight.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/bikes.jpg\",\"kruse-group\",\"Leaves\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/constant-variable.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/light_weight.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/loops.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/minor-miracle.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/neue.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/patterns.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/plate.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/roundwindow.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/slant.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/slip.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/stadelschule.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/straw.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/utter.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/water.jpg\",\"kruse-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n  \\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n  \\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/kruse/impossiblepaper.jpg\",\"kruse-group\",\"Impossible Paper Architecture\"]]],false],[\"text\",\"\\n  \\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t    \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Artist Bio/Statement\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Brandi Kruse grew up in Ypsilanti, Michigan and received her BS in Education at Central Michigan University where she studied literature and photography. She moved to Portland, OR in 2008. After teaching high school language arts and studio arts for eight years, she recently graduated with an MFA in Print Media from Pacific Northwest College of Art. In no particular order, she thinks of herself as a teacher, photographer, printmaker, and poet. Her work is dependent on time, light, and reflection and she often questions what is gained and what is lost in this reliance.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Most of the work Kruse has on display are her photogravure etchings. This intaglio technique maintains fine details, an unparalleled tonal range and contrast, and is perfect for her rich imagery of structure, light, and illusion. Using this analogue process, she returns to the darkroom, where she began as a photographer. In making a photogravure plate, she exposes an image onto fragile, light-sensitive gelatin. Immediately after exposing the gelatin, she gently presses it face down onto a copper plate in cold water. In water just right for a baby’s bath, she watches as the latent image is born, the gelatin dissolving into varying hills and valleys, in some places nearly exposing the copper beneath. Later, the layers of gelatin determine the depth of the etch across the surface of the copper. This haptic process holds itself in stark relief to contemporary digital processes in a way that Kruse finds deeply satisfying. She sees slowing down and heightening awareness in small details as a welcome gift.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Many of these pieces are part of an ongoing body of work in which excerpts from her photographs are presented as framing devices. This process allows her to elevate the overlooked and question relationships. There is tension to be explored between presence and erasure, past and potential, the tangible and the imagination, the written and the reader.\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Flickerbox, Inc., PDX\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/kruse.hbs" } });
});
...
define("verge-ember/templates/artist/miyamoto", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "NaUeVhDV", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Kanani Miyamoto\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,0],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\tMay 2017\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n\\t    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/miyamoto/thesis2.jpg\",\"miyamoto-group\",\"Dorothy Lemelson Studio Installation 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/miyamoto/grandfather.jpg\",\"miyamoto-group\",\"Grandfather\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/miyamoto/mfa_print.jpg\",\"miyamoto-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/miyamoto/pdxbldg.jpg\",\"miyamoto-group\",\"Portland Building Installation 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/miyamoto/pdxbldg2.jpg\",\"miyamoto-group\",\"Portland Building Installation 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/miyamoto/redcreature.jpg\",\"miyamoto-group\",\"Red Creature\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t    \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Flickerbox, Inc., PDX\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/miyamoto.hbs" } });
});
define("verge-ember/templates/artist/morin", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "QGAaCDRE", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Bertrand Morin\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"July 2016\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tFlickerbox, Inc.\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tPortland Oregon\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tContact Alanna for Viewing Appointments\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"comment\",\" <img src=\\\"/assets/images/morin/planetoid10_1024.jpg\\\"> \"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n\\t    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid01.jpg\",\"morin-group\",\"Planetoid 001\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid02.jpg\",\"morin-group\",\"Planetoid 002\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid03.jpg\",\"morin-group\",\"Planetoid 003\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid04.jpg\",\"morin-group\",\"Planetoid 004\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid05.jpg\",\"morin-group\",\"Planetoid 005\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid06.jpg\",\"morin-group\",\"Planetoid 006\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid07.jpg\",\"morin-group\",\"Planetoid 007\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid08.jpg\",\"morin-group\",\"Planetoid 008\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid09.jpg\",\"morin-group\",\"Planetoid 009\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid10.jpg\",\"morin-group\",\"Planetoid 010\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid11.jpg\",\"morin-group\",\"Planetoid 011\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid12.jpg\",\"morin-group\",\"Planetoid 012\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid13.jpg\",\"morin-group\",\"Planetoid0 13\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid14.jpg\",\"morin-group\",\"Planetoid 014\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid17.jpg\",\"morin-group\",\"Planetoid 017\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid20.jpg\",\"morin-group\",\"Planetoid 020\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid21.jpg\",\"morin-group\",\"Planetoid 021\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid23.jpg\",\"morin-group\",\"Planetoid 023\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid26.jpg\",\"morin-group\",\"Planetoid 026\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid27.jpg\",\"morin-group\",\"Planetoid 027\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid28.jpg\",\"morin-group\",\"Planetoid 028\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid33.jpg\",\"morin-group\",\"Planetoid 033\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/morin/planetoid34.jpg\",\"morin-group\",\"Planetoid 034\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t    \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Statement\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"In my work I use a combination of photographic processes and text to transform ordinary objects and places into strange and bizarre pseudoscientific entities. The subjects of the images are separated from their original context by the physical act of collection and removal, or by careful photographic composition. They are then recombined and cataloged with one another to form new relationships, vocabularies, networks of meaning, and narrative links. The transformation of images and objects is intended to undermine the ways that organizational systems, methods of display, and the truth value assigned to facts and histories mask authorship, ideologies, and limit individual perception. The work is narrative and intended to deeply engage viewers' imaginations through its fantastical, humorous, and sometimes disquieting content. Viewers are left to follow subtle clues and connections to form their own unique links between the images and text. Observation is the backbone of my creative process. I use written and photographic observations as the foundation for the creation of fictional characters, alternate worlds, and illogical anthropologies. The various levels of obfuscation and revelation that the text and images provide for viewers is intended to place my work in a limbo between truth and fiction, and to bend the line between historical archive and pseudoscientific farce.\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://bertrandmorin.net/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"BertrandMorin.net\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/morin.hbs" } });
});
define("verge-ember/templates/artist/mulder", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "EOCCYREc", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Rachel Mulder\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,1],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tFebruary 2017\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tOpening Reception: February 16th 7-10pm\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t321 SW 4th, Suite 501, Portland OR\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tPlease note, this is a private office space, no drop-ins.\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tcontact me for viewing appointments\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/onthefloor.jpg\",\"mulder-group\",\"On The Floor\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/somanytimes.jpg\",\"mulder-group\",\"So Many Times\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/duo.jpg\",\"mulder-group\",\"Duo\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/shadowshadow.jpg\",\"mulder-group\",\"Shadow Shadow\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/outline.jpg\",\"mulder-group\",\"Outline\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/collection.jpg\",\"mulder-group\",\"Collection\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/jamond.jpg\",\"mulder-group\",\"Jamond\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/kierre.jpg\",\"mulder-group\",\"Kiere\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/michael.jpg\",\"mulder-group\",\"Michael\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/cyan.jpg\",\"mulder-group\",\"Cyan\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/michelle.jpg\",\"mulder-group\",\"Michelle\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/nervoushands.jpg\",\"mulder-group\",\"Nervous Hands\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/nic.jpg\",\"mulder-group\",\"Nic\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/carissa.jpg\",\"mulder-group\",\"Carissa\"]],0],[\"text\",\"      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/preciouscargo.jpg\",\"mulder-group\",\"Precious Cargo\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/selfportrait1.jpg\",\"mulder-group\",\"Self Portrait\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/selfportrait1024.jpg\",\"mulder-group\",\"Self Portrait V\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/sisters.jpg\",\"mulder-group\",\"Sisters\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/thom.jpg\",\"mulder-group\",\"Thom\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/mulder/topheavy.jpg\",\"mulder-group\",\"Top Heavy\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Artist Bio:\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Rachel Mulder earned her BFA in Printmaking from the Milwaukee Institute of Art & Design and has since adapted those printmaking techniques and processes into other art forms, namely drawing. She has been an art-assistant/direct care worker, helping others make art based on their individual desires as well as in workshop settings, and is currently teaching Experimental Drawing for local nonprofit \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.publicannex.org/\"],[\"flush-element\"],[\"text\",\"Public Annex\"],[\"close-element\"],[\"text\",\". She is a Midwestern native and lives and works in Portland, Oregon.\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"https://rachelmulderart.blogspot.com/\"],[\"flush-element\"],[\"text\",\"rachelmulderart.blogspt.com\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[],\"locals\":[]},{\"statements\":[[\"text\",\"Flickerbox, Inc., PDX\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/mulder.hbs" } });
});
define("verge-ember/templates/artist/nelson", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "H5F9gVch", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Kara Nelson\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,0],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tDecember 2016\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"comment\",\" <img src=\\\"/assets/images/nelson/reds1024.jpg\\\"> \"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n\\t    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/nelson/leaves.jpg\",\"nelson-group\",\"Leaves\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/nelson/liquidsilver.jpg\",\"nelson-group\",\"Liquid Silver\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/nelson/ontheedge.jpg\",\"nelson-group\",\"On the Edge\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/nelson/white.jpg\",\"nelson-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t    \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Biography\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Kara Nelson is an artist living and working in the Oakland, CA. She uses her own trash to collage images of landscapes and make small-scale, abstract, and sometimes functional sculptures. Her work has been shown in group and solo exhibitions in galleries, and exhibitions in private homes.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Originally from the North West, Kara references elements of those landscapes in the images she creates. These signifiers are increasingly mixed with reference to the California landscapes she interacts with daily. For Kara, living sometimes means needing to use objects that can have harmful environmental effects. She creates her work as atonement for using. It serves as a reminder to tread lightly in the world in order to minimize her negative effect on the environment.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Statement\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"I believe the world moves in cyclical patterns: birth, death, and decay, which in turn fuels further growth. But the waste which humans produce is disruptive to this cycle. By creating landscapes with discarded materials, I am attempting to give them a longer and more meaningful life. By taking something that inhibits life and using it to create something that represents it, I hope to call attention to the function waste can serve.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.karanelson.com/\"],[\"flush-element\"],[\"text\",\"http://www.karanelson.com/\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tInstagram: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://instagram.com/kara_nelson\"],[\"flush-element\"],[\"text\",\"@kara_nelson\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Flickerbox, Inc., PDX\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/nelson.hbs" } });
});
define("verge-ember/templates/artist/quiroz", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "2B87u7Nb", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Amanda Quiroz\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,1],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tJune 15, 2017 - August 15, 2017\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/beemouth1.png\",\"quiroz-group\",\"Bee Mouth Parts I | graphite on Rives BFK | 6 x 6 2015\"]],0],[\"text\",\"      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/beemouth2.png\",\"quiroz-group\",\"Bee Mouth Parts II | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/houseflycross.png\",\"quiroz-group\",\"Housefly Cross-section | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/houseflyleg1.png\",\"quiroz-group\",\"Housefly Leg I | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/houseflyleg2.png\",\"quiroz-group\",\"Housefly Leg II | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/pollenleg1.png\",\"quiroz-group\",\"Pollen Leg I | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/pollenleg2.png\",\"quiroz-group\",\"Pollen Leg II | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/quiroz/variousantenna.png\",\"quiroz-group\",\"Various Antenna | graphite on Rives BFK | 6 x 6 2015\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\n\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Statement\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Ever since the creation of the world, his invisible attributes of eternal power and divinity have been able to be understood and perceived in what he has made. Romans 1:20\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"I draw the minutiae I find and collect in everyday interactions with nature; primarily, over-looked objects that are typically thought of as dust: dried seeds, dead insects, fallen feathers, strands of hair... I combine these small forms to scale within accumulated compositions using ethereal abstraction inspired by early photomicroscopy and astrophotography. I am stimulated by this subject matter philosophically, as it leads to theological conversations. Scientific illustration, Italian Renaissance art, along with Catholicism and divine phenomena all commingle in an undercurrent influencing my work. I’m drawn to harmonious parallels between the infinitesimal and the grandiose through my process.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Drawing with finite exactitude, I use basic observation employing unaided eyesight and homemade microscopes. While I aim to record each specimen accurately, inevitably each rendered organic object becomes a shadow of a shadow. I translate the perfectly designed imperfectly. By attempting to capture each nuance, my sensitivity is heightened and my awe is deepened; my limitations are enlarged and my vulnerability is magnified. The minute comes into focus and I see the details signifying something greater and far more mysterious, sparking an inclination to reason from the visible to the invisible in an unfolding relationship.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"I specifically refer to insects as a constant subject within my work and see them in the same way C.S. Lewis has described them as \\\"a dim shadow or symbol of the unceasing activity and creativeness of God.\\\" I draw them to grow in humility and highlight mortality as I am ever fascinated by the reality of the immortal soul. I seek to develop an ongoing visual vocabulary to speak with faith and reason as an instrument to pass on pinpoints of truth.\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://http://amandaquiroz.com/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"http://amandaquiroz.com/\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"Instagram \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://instagram.com/illuminatedust\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"@illuminatedust\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[],\"locals\":[]},{\"statements\":[[\"text\",\"Flickerbox, Inc.\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/quiroz.hbs" } });
});
...
define("verge-ember/templates/artist/reeves", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "iC+1AOPf", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Veronica Reeves\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Bright Spots\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tSeptember 2016\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"block\",[\"link-to\"],[\"venues\"],null,0],[\"text\",\", Portland OR\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"comment\",\" <img src=\\\"/assets/images/reeves/breathingspace1024.jpg\\\"> \"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n\\t    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/alongtheriver.jpg\",\"reeves-group\",\"\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/aquasprites.jpg\",\"reeves-group\",\"Aqua Sprites\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/atmosphericshore.jpg\",\"reeves-group\",\"Atmospheric Shore\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/breathingspace.jpg\",\"reeves-group\",\"Breathing Space\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/celestialspot.jpg\",\"reeves-group\",\"Celestial Spot\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/crustaceanquest.jpg\",\"reeves-group\",\"Crustacean Quest\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/glimpse.jpg\",\"reeves-group\",\"Glimpse\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/glitter_alliteration.jpg\",\"reeves-group\",\"Glitter Alliteration\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/horizongate.jpg\",\"reeves-group\",\"Horizon Gate\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/lifelover.jpg\",\"reeves-group\",\"Life Lover\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/light_gravity.jpg\",\"reeves-group\",\"Light Gravity\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/middleofeverywhere.jpg\",\"reeves-group\",\"Middle of Everywhere\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/mist_light.jpg\",\"reeves-group\",\"Mist Light\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/nebulahomes.jpg\",\"reeves-group\",\"Nebula Homes\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/othertide.jpg\",\"reeves-group\",\"Other Tide\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/reeves/valleyvisit.jpg\",\"reeves-group\",\"Vallery Visit\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t    \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Bright Spots\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"An asteroid crash lands on a planet conducive to life. It is carrying proteins, seeds, spores, and data from another world that faced a cataclysmic event. Through layers of masking, spray paint, spills, and hand painting techniques, I visualize places of post-dystopian sanctuary. Pulling from aesthetics of digital games, visionary art, images of outer space, and earth processes, Bright Spots hints at fragments of new life slowly unfolding against the odds. As long as there is RNA, and DNA, it’ll be okay.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Wesbite: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.v2r2please.com/\"],[\"flush-element\"],[\"text\",\"http://www.v2r2please.com/\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Flickerbox, Inc.\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/reeves.hbs" } });
});
define("verge-ember/templates/artist/risse", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "oFs1/TVF", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Alanna Risse\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,0],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tMay, 2016\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"comment\",\" <img src=\\\"/assets/images/risse/fifthwheel1024.jpg\\\"> \"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n\\t    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/risse/dif.jpg\",\"risse-group\",\"Taste the Dif | 10x10 | oil on canvas | 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/risse/odalisque.jpg\",\"risse-group\",\"Odalisque | 16x16 | Oil on Canvas | 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/risse/freckles.jpg\",\"risse-group\",\"Freckles | 10x10 | Oil on Canvas | 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/risse/pie.jpg\",\"risse-group\",\"Pie | 20x10 | Pastel on Paper | 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/risse/spritzer.jpg\",\"risse-group\",\"Spritzer | 20x10 | Pastel on Paper | 2016\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/risse/peelup.jpg\",\"risse-group\",\"Don't Peel Up On Me\"]]],false],[\"text\",\"\\n\\t      \\t\"],[\"close-element\"],[\"text\",\"\\n\\t    \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Art Manifesto\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Let art be an experience. Free it from its frame, it’s pedestal. Shatter the glass that seals it off from the world. Let it absorb finger grease, get dropped, dinged, damaged. Give it life, let it into our lives. Put it in unexpected places. Share it, don’t squander it. Art doesn’t need anyone’s protection. Set it free.\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://alannarisse.com\"],[\"flush-element\"],[\"text\",\"AlannaRisse.com\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tInstagram: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"https://www.instagram.com/alannarisse/\"],[\"flush-element\"],[\"text\",\"@alannarisse\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Flickerbox, Inc., PDX\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/risse.hbs" } });
});
define("verge-ember/templates/artist/schlunegger", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "KuFdqOpR", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-page\"],[\"flush-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Danielle Schlunegger-Warner\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"venues\"],null,1],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tFebruary 2017\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\tOpening Reception: February 12th 7-10pm\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t5128 N Albina, Portland OR 97217\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"artist-thumbs\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/blackbear1.jpg\",\"schlun-group\",\"The Approach Of The Irrepressible Conflict\"]],0],[\"text\",\"      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/blackbear3.jpg\",\"schlun-group\",\"The Approach Of The Irrepressible Conflict\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/bobcat1.jpg\",\"schlun-group\",\"Cave Bobcat\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/bobcat2.jpg\",\"schlun-group\",\"Cave Bobcat\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/bobcat3.jpg\",\"schlun-group\",\"Cave Bobcat\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/bobcat4.jpg\",\"schlun-group\",\"Cave Bobcat\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/flatnose1.jpg\",\"schlun-group\",\"Agricultural Imperialism and the Balance of Power\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/flatnose2.jpg\",\"schlun-group\",\"Agricultural Imperialism and the Balance of Power\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/flatnose3.jpg\",\"schlun-group\",\"Agricultural Imperialism and the Balance of Power\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/grizzly1.jpg\",\"schlun-group\",\"Westward to the Pacific\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/grizzly2.jpg\",\"schlun-group\",\"Westward to the Pacific\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/grizzly3.jpg\",\"schlun-group\",\"Westward to the Pacific\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/grizzly4.jpg\",\"schlun-group\",\"Westward to the Pacific\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-4 col-md-3 col-lg-3\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"light-box\"],null,[[\"href\",\"data-lightbox\",\"data-title\"],[\"/assets/images/schlunegger/rfinstall1024.jpg\",\"schlun-group\",\"Red Fox Installation View\"]]],false],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\\n\\n\\n\\n\\n\\n\\n\\t\"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Statement\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Danielle Schlunegger-Warner grew up amongst the shell shops and sand dunes of Ventura, CA. Her artwork is strongly influenced by 18th century Cabinets of Curiosity and early explorers.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Inspired by natural history and the museums that house it, Danielle creates her own worlds within this established context. Her new work presents a vision of exploration and conquest during the Age of Imperialism in the Americas, searching for the elusive and misguided promise of truly untouched lands from the perspective of naturalists, who are themselves invaders.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Graduating with a BFA from California College of Arts in 2010 with distinction, Danielle received the All College Honors award for her work on The Marcus Kelli Collection and was awarded the 2014 Affiliate Artist Award From the Headlands Center for the Arts in Marin, CA. Danielle currently and lives and works from her home studio in Portland, Oregon and writes remotely for \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.venisonmagazine.com/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Venison \"],[\"close-element\"],[\"text\",\"Magazine.\"],[\"close-element\"],[\"text\",\"\\n\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://schlunegger.com/\"],[\"flush-element\"],[\"text\",\"http://schlunegger.com/\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"Instagram & Twitter @naturalistandco\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"artist-page-nav\"]],false],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[],\"locals\":[]},{\"statements\":[[\"text\",\"The Red Fox\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/artist/schlunegger.hbs" } });
});
...
define("verge-ember/templates/components/berlin-gallery", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "1+6lm3nW", "block": "{\"statements\":[[\"open-element\",\"article\",[]],[\"dynamic-attr\",\"id\",[\"unknown\",[\"berlinGallery\",\"id\"]],null],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"img\",[]],[\"dynamic-attr\",\"src\",[\"concat\",[[\"unknown\",[\"berlinGallery\",\"image\"]]]]],[\"dynamic-attr\",\"alt\",[\"concat\",[[\"unknown\",[\"berlinGallery\",\"caption\"]]]]],[\"flush-element\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"berlinGallery\",\"imgname\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"static-attr\",\"class\",\"about\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"berlinGallery\",\"info\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\t\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/components/berlin-gallery.hbs" } });
});
define("verge-ember/templates/components/footer-nav", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "idcOws1N", "block": "{\"statements\":[[\"open-element\",\"footer\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"mobile-footer\"],[\"flush-element\"],[\"text\",\"© Copyright Verge PDX 2017\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"footer\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n      \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"left col-sm-6 col-md-6\"],[\"flush-element\"],[\"text\",\"\\n    \\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"© Copyright Verge PDX 2017\"],[\"close-element\"],[\"text\",\"\\n          \\t\"],[\"close-element\"],[\"text\",\"\\n          \\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col-sm-6 col-md-6\"],[\"flush-element\"],[\"text\",\"\\n      \\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n    \\t\\t\\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://alannarisse.com/webdev\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Alanna Risse\"],[\"close-element\"],[\"text\",\"  \\n    \\t\\t\\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"https://www.linkedin.com/in/alanna-risse-portland\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-linkedin\"],[\"static-attr\",\"style\",\"font-size:24px\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\" \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://github.com/alannarisse\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"fa fa-github\"],[\"static-attr\",\"style\",\"font-size:24px\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n      \\t\"],[\"close-element\"],[\"text\",\"\\n\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/components/footer-nav.hbs" } });
});
...
define("verge-ember/templates/components/navigation-list", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "RybpARaN", "block": "{\"statements\":[[\"block\",[\"bs-navbar\"],null,[[\"type\"],[[\"get\",[\"type\"]]]],13],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[{\"statements\":[[\"text\",\"About\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"nav\",\"link-to\"],[\"about\"],null,0]],\"locals\":[]},{\"statements\":[[\"text\",\"News\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"nav\",\"link-to\"],[\"news\"],null,2]],\"locals\":[]},{\"statements\":[[\"text\",\"Venues\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"nav\",\"link-to\"],[\"venues\"],null,4]],\"locals\":[]},{\"statements\":[[\"text\",\"Artists\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"nav\",\"link-to\"],[\"artists\"],null,6]],\"locals\":[]},{\"statements\":[[\"text\",\"Home\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"nav\",\"link-to\"],[\"index\"],null,8]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t    \"],[\"block\",[\"nav\",\"item\"],null,null,9],[\"text\",\"\\n\\t    \"],[\"block\",[\"nav\",\"item\"],null,null,7],[\"text\",\"\\n\\t    \"],[\"block\",[\"nav\",\"item\"],null,null,5],[\"text\",\"\\n\\t    \"],[\"comment\",\" {{#nav.item}}{{#nav.link-to 'exhibitions'}}Exhibition List{{/nav.link-to}}{{/nav.item}} \"],[\"text\",\"\\n\\t    \"],[\"block\",[\"nav\",\"item\"],null,null,3],[\"text\",\"\\n\\t    \"],[\"comment\",\" {{#nav.item}}{{#nav.link-to 'contacts'}}Contact{{/nav.link-to}}{{/nav.item}} \"],[\"text\",\"\\n\\t   \\t\"],[\"block\",[\"nav\",\"item\"],null,null,1],[\"text\",\"\\n\"]],\"locals\":[\"nav\"]},{\"statements\":[[\"block\",[\"navbar\",\"nav\"],null,null,10]],\"locals\":[]},{\"statements\":[[\"text\",\"      \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"sr-only\"],[\"flush-element\"],[\"text\",\"Toggle navigation\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"icon-bar\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"icon-bar\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"icon-bar\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"navbar-header\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"navbar\",\"toggle\"],null,null,12],[\"text\",\"  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"navbar\",\"content\"],null,null,11]],\"locals\":[\"navbar\"]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/components/navigation-list.hbs" } });
});
define("verge-ember/templates/components/venue-list", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "ACCi6C3y", "block": "{\"statements\":[[\"open-element\",\"article\",[]],[\"dynamic-attr\",\"id\",[\"unknown\",[\"venueList\",\"id\"]],null],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"a\",[]],[\"dynamic-attr\",\"href\",[\"unknown\",[\"venueList\",\"link\"]],null],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"dynamic-attr\",\"src\",[\"concat\",[[\"unknown\",[\"venueList\",\"image\"]]]]],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"venueList\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"append\",[\"unknown\",[\"venueList\",\"about\"]],false],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Website: \"],[\"open-element\",\"a\",[]],[\"dynamic-attr\",\"href\",[\"unknown\",[\"venueList\",\"link\"]],null],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"venueList\",\"link\"]],false],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\t\\n\\n\\n\\n\"],[\"comment\",\" <article id={{venueList.id}}>\\n\\t<a href={{venueList.link}} target=\\\"_blank\\\">\\n\\t{{venue-title venueList.title venueList.about venueList.address}}\\n\\t</a>\\n</article>\\t\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/components/venue-list.hbs" } });
});
define("verge-ember/templates/contacts", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "P5rhnDLn", "block": "{\"statements\":[[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Contact\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Interested a viewing appointment? \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=Viewing Appointment\"],[\"flush-element\"],[\"text\",\"Contact me\"],[\"close-element\"],[\"text\",\" via email.\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Would you like Portland to rotate art shows in your Portland business? \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=Interested in Verge Curatorial Services\"],[\"flush-element\"],[\"text\",\"Contact me\"],[\"close-element\"],[\"text\",\".\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Artists: If you are interested in showing with Verge, please send me a link to your portfolio and a \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com?subject=artist interested in Verge\"],[\"flush-element\"],[\"text\",\"brief email\"],[\"close-element\"],[\"text\",\" describing how you see your work fitting into the Verge catalog.\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/contacts.hbs" } });
});
define("verge-ember/templates/exhibitions", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "VEf+lsNV", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/exhibitions.hbs" } });
});
define("verge-ember/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "hmdAfSu6", "block": "{\"statements\":[[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"title\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"section\",[]],[\"static-attr\",\"class\",\"featured-artists\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"block\",[\"link-to\"],[\"artist.mulder\"],null,7],[\"text\",\"\\n        \"],[\"open-element\",\"h2\",[]],[\"static-attr\",\"class\",\"marketing-columns\"],[\"flush-element\"],[\"block\",[\"link-to\"],[\"artist.mulder\"],null,6],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Rachel Mulder creates images through repetitive mark making. Her show at Flickerbox, Inc., in downtown Portland will be up through the month of February, 2017.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"The opening reception is Thursday, \"],[\"open-element\",\"strong\",[]],[\"flush-element\"],[\"text\",\"February 16th 7-10pm\"],[\"close-element\"],[\"text\",\". 321 SW 4th Ave, Suite 501, Portland OR. PLEASE NOTE: this is a private office. if you are unable to attend the reception and would like to see the show, please \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"mailto:alanna@vergepdx.com\"],[\"flush-element\"],[\"text\",\"email me\"],[\"close-element\"],[\"text\",\".\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"block\",[\"link-to\"],[\"artist.schlunegger\"],null,5],[\"text\",\"\\n        \"],[\"open-element\",\"h2\",[]],[\"static-attr\",\"class\",\"marketing-columns\"],[\"flush-element\"],[\"block\",[\"link-to\"],[\"artist.schlunegger\"],null,4],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Danielle Schlunegger creates faux taxidermy animals out of fake fur and old books.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Schlunegger-Warner is showing a installation of bear heads and cave bobcats at Red Fox Bar in North Portland for the month of Februaru 2017. Schlunegger-Warner's reception is \"],[\"open-element\",\"strong\",[]],[\"flush-element\"],[\"text\",\"Sunday Febrtuary 12th\"],[\"close-element\"],[\"text\",\", 7-9pm.\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"block\",[\"link-to\"],[\"artist.berlin\"],null,3],[\"text\",\"\\n        \"],[\"open-element\",\"h2\",[]],[\"static-attr\",\"class\",\"marketing-columns\"],[\"flush-element\"],[\"block\",[\"link-to\"],[\"artist.berlin\"],null,2],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Jason Berlin will be showing paintings at Red Fox in North Portland March 2017.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Berlin works in the medium of oil painting, sculpture, installation, college, and curation. Berlin’s work has been exhibited in numerous art shows in the Pacific Northwest, and in group exhibitions in New York, France, and Vancouver BC.\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"block\",[\"link-to\"],[\"artist.void\"],null,1],[\"text\",\"\\n        \"],[\"open-element\",\"h2\",[]],[\"static-attr\",\"class\",\"marketing-columns\"],[\"flush-element\"],[\"block\",[\"link-to\"],[\"artist.void\"],null,0],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Epochal Void will be showing drawings at Flickerbox, Inc. in March 2017.\"],[\"close-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Specializing in conceptual drawing, printmaking, mixed media art, paper sculpture, lettering and collage, Epochal Void creates bodies of work which explore concepts of impermanence, betweenness, as well as social & spiritual bondage. The process is, itself, a gesture of freedom, of liberation from the constraint of measurement, of definition, of expectation.\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Epochal Void\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/features/void348x220.png\"],[\"static-attr\",\"alt\",\"Epochal Void\"],[\"flush-element\"],[\"close-element\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Jason Berlin\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/features/berlin348x220.jpg\"],[\"static-attr\",\"alt\",\"Jason Berlin Thomas\"],[\"flush-element\"],[\"close-element\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Danielle Schlunegger-Warner\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/features/schlunegger348x220.jpg\"],[\"static-attr\",\"alt\",\"Danielle Schlunegger-Warner\"],[\"flush-element\"],[\"close-element\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Rachel Mulder\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/features/mulder348x220.jpg\"],[\"static-attr\",\"alt\",\"Rachel Mulder\"],[\"flush-element\"],[\"close-element\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/index.hbs" } });
});
define("verge-ember/templates/news", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "WlVfKe71", "block": "{\"statements\":[[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"In The News\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"section\",[]],[\"static-attr\",\"class\",\"news\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row auto-clear\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Danielle Schlunegger-Warner 2017 Glean Artist in Residence\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.gleanpdx.org/2017/02/15/congratulations-glean-2017-artists/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"The Glean Artist Resiency\"],[\"close-element\"],[\"text\",\" has chosen Danielle Schlunegger-Warner as one of their five artists in residence for 2017! Congratulations Danielle!\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"figure\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.gleanpdx.org/2017/02/15/congratulations-glean-2017-artists/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/news/glean.png\"],[\"static-attr\",\"alt\",\"Danielle Schlunegger-Warner at Glean\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\">> Visit \"],[\"block\",[\"link-to\"],[\"artist.schlunegger\"],null,6],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Veronica Reeves at Rainmaker\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.rainmakerartistresidency.org/news/veronica-reeves-radiant-angle\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Rainmaker Artist Residency\"],[\"close-element\"],[\"text\",\" press release of Veronica Reeve's solo exhibition at Rainmaker Artist Residency in December 2016.\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"figure\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.rainmakerartistresidency.org/news/veronica-reeves-radiant-angle\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/news/veronica_rainmaker_dec2016.jpg\"],[\"static-attr\",\"alt\",\"Veronica Reeves at Rainmaker\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\">> Visit \"],[\"block\",[\"link-to\"],[\"artist.reeves\"],null,5],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Jason Berlin and Alanna Risse at Rainmaker\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.portlandart.net/archives/2017/01/alanna_risse_at.html\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"PORT review\"],[\"close-element\"],[\"text\",\" of Jason Berlin's solo exhibition at Rainmaker Artist Residency in January 2017 with guest artist \"],[\"block\",[\"link-to\"],[\"artist.risse\"],null,4],[\"text\",\" in the lobby installation space.\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"figure\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://www.portlandart.net/archives/2017/01/alanna_risse_at.html\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/news/port_jan2017.jpg\"],[\"static-attr\",\"alt\",\"Portlandart.net\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\">> Visit \"],[\"block\",[\"link-to\"],[\"artist.berlin\"],null,3],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\">> Visit \"],[\"block\",[\"link-to\"],[\"artist.risse\"],null,2],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Kanani Miyamoto at Portland Building\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Uber talented printmaker and Verge's May 2017 featured artist Kanani Miyamoto created a large wall mural at the Portland Building in \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"https://www.racc.org/2016/06/03/industry-of-aloha-an-art-installation-by-kanani-miyamoto-opens-at-the-portland-building-june-1-june-24/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"RACC's installation space\"],[\"close-element\"],[\"text\",\" in June 2016.\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"figure\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"https://www.racc.org/2016/06/03/industry-of-aloha-an-art-installation-by-kanani-miyamoto-opens-at-the-portland-building-june-1-june-24/\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/news/miyamoto_racc.jpg\"],[\"static-attr\",\"alt\",\"Ehren Reed on MLFY\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\">> Visit \"],[\"block\",[\"link-to\"],[\"artist.miyamoto\"],null,1],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"col-xs-12 col-sm-6 col-md-6 col-lg-4\"],[\"flush-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"h3\",[]],[\"flush-element\"],[\"text\",\"Ehren Reed Interview on My Love For You\"],[\"close-element\"],[\"text\",\"\\n\\t      \\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"Meighan O'Toole \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://myloveforyou.typepad.com/my_love_for_you/2010/03/ehren-elizabeth-reed.html\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"Interviewed Ehren Reed\"],[\"close-element\"],[\"text\",\" back in 2010 for her blog My Love For You.\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"figure\",[]],[\"flush-element\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"http://myloveforyou.typepad.com/my_love_for_you/2010/03/ehren-elizabeth-reed.html\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"open-element\",\"img\",[]],[\"static-attr\",\"src\",\"/assets/images/news/ehrenreed_mlfy.jpg\"],[\"static-attr\",\"alt\",\"Ehren Reed on MLFY\"],[\"flush-element\"],[\"close-element\"],[\"close-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\">> Visit \"],[\"block\",[\"link-to\"],[\"artist.reed\"],null,0],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"Ehren Reed's Artist Page\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Kanani Miyamoto's Artist Page\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Alanna Risse's Artist Page\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Jason Berlin's Artist Page\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Alanna Risse\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Veronica Reeves's Artist Page\"]],\"locals\":[]},{\"statements\":[[\"text\",\"Danielle Schlunegger-Warner's Artist Page\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/news.hbs" } });
});
...
define("verge-ember/templates/posts", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Dl6PghLi", "block": "{\"statements\":[[\"open-element\",\"h2\",[]],[\"flush-element\"],[\"text\",\"Posts\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"section\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\"]]],null,0],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"open-element\",\"div\",[]],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"post\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"post\",\"body\"]],false],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"post\"]}],\"hasPartials\":false}", "meta": { "moduleName": "verge-ember/templates/posts.hbs" } });
});
...
define('verge-ember/torii-providers/firebase', ['exports', 'emberfire/torii-providers/firebase'], function (exports, _emberfireToriiProvidersFirebase) {
...
if (!runningTests) {
  require("verge-ember/app")["default"].create({"name":"verge-ember","version":"0.0.0+04435900"});
}
